return [
...

  {
    ...
    type: "select",
    required: true,
    options: cuerdas.map((c) => ({ id: c.id, nombre: c.name })), // ✔️ ahora trae id y nombre
  },

  {
    ...
    label: "Área",
    type: "select",
    options: areas.map((a) => ({ id: a.id, nombre: a.name })), // ✔️ idem
  },
