  ...
  useEffect(() => {
    const onClick = (e) => {
      ...
      const sticky =
        ...
        document.querySelector('.landing-header nav');
      const navHeight = sticky ? sticky.getBoundingClientRect().height : 0;
      e.preventDefault();
      container.scrollTo({
        top: Math.max(0, offset - navHeight - 8),
        behavior: 'smooth',
      });
    };
    ...
    <main className="landing-page">
      <nav className="site-nav">
        <ul>
          <li>
            <img
              src="./public/logo-coro-sin-fondo.png"
              alt="Logo"
              className="logo"
            />
          </li>
        ...
        <div className="header-content">
          <div className="header-text">
            ...
            <div className="contactos">
              <a
                href="https://maps.app.goo.gl/C9NKv8odtc4EMX3H9"
                title="Ubicación"
              >
                <UbicacionIcon
                  width={24}
              ...
              <a href="https://www.youtube.com/@corocapuchinos" title="Youtube">
                <YouTubeIcon
                  style={{ color: 'var(--text-light)', width: 30, height: 30 }}
                />
              </a>
              <a
                href="https://open.spotify.com/intl-es/artist/56Yt1Z4IFBnwXIizaoMyXb?si=WPoK38QJQtaRsC3ujt1shA"
                title="Spotify"
              >
                <SpotifyIcon
                  style={{ color: 'var(--text-light)', width: 24, height: 24 }}
                />
              </a>
              <a
                href="https://www.facebook.com/corouniversitario.capuchinos"
                title="Facebook"
              >
                <FacebookIcon
                  style={{ color: 'var(--text-light)', width: 24, height: 24 }}
              ...
              <a
                href="https://www.instagram.com/corocapuchinos/"
                title="Instagram"
          ...
          <div className="header-logo">
            <img
              src="./public/logo capuchinos.png"
              alt="logo"
              className="logo"
            />
          </div>
      ...
      <article className="landing-article">
        <section id="quienes-somos" className="section-line">
          ...
          <p>
            ...
            un encuentro personal con Jesucristo, respondemos al llamado de Dios
            a ejercer un Ministerio de Música y Canto en nuestra comunidad.
            <br />
            <br />
            Nuestra misión principal es servir a la comunidad acompañándola en
            la oración a través de la música. Nos esforzamos por ser
            instrumentos de la Palabra de Dios, utilizando nuestro propio
            carisma.
            <br />
            <br />
        ...
        <div className="container-photo-activities">
          ...
          <ContainerPhoto>
            <img
              src="./public/misa fin de año 2020.jpg"
              alt="Misa fin de año"
              className="activity-photo"
            />
          </ContainerPhoto>
          ...
          <ContainerPhoto>
            <img
              src="./public/convi coro 2022.jpg"
              alt="Coro con Sauro"
              className="activity-photo"
            />
          </ContainerPhoto>
        ...
        <section id="Unite" className="section-line">
          ...
          <p>
            ...
            la Misa de los domingos a las 21. Además, también cantamos en misas
            especiales, eventos solidarios, encuentros de coros y en otras
            comunidades que necesiten de nuestro servicio, agregando ensayos
            excepcionales en caso de ser necesario.
            <br />
            <br />
            Nuestros ensayos son los días sábados (excepto los segundos fines de
            cada mes, que ensayamos un viernes) de 20:30 a 22:30 y los domingos
            una hora antes de la Misa (20h). Es importante para nosotros la
            asistencia a los ensayos; ahí compartimos en fraternidad la música,
            nos preparamos para hacer crecer ese don que Dios puso en cada uno.
            <br />
            <br />
            Si te animas a comprometerte con lo anterior, ¡¡completa los datos
            de inscripción!!
          </p>
